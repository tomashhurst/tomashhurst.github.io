...
![Flyer](https://raw.githubusercontent.com/tomashhurst/tomashhurst.github.io/master/images/Leiden2.png)

---

**Seminar: Department of Parasitology, Leiden University Medical Center**

Thursday 11-March-2021: 9 am CET (UTC+1) / 7 pm AEDT (Sydney/Melbourne/Canberra). Join via this [Microsoft Teams](https://protect-au.mimecast.com/s/JWn9COMKzVTBX8MYIPpyeQ?domain=teams.microsoft.com) link.
...
<div class='row'>
    <div class="image">
        <a href="#">
            <img src="https://raw.githubusercontent.com/tomashhurst/tomashhurst.github.io/master/images/TA%20cropped.jpg" alt="icon" width="150" align="right" style="padding-left: 0px; padding-right: 10px; padding-top: 0px; padding-bottom: 5px">
        </a>
    </div>
</div> 
