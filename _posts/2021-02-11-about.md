...
&nbsp&nbsp{% if site.footer-links.email %}<a href="mailto:{{ site.footer-links.email }}"><i class="svg-icon email"></i></a>{% endif %}
  [thomas.ashhurst@sydney.edu.au](thomas.ashhurst@sydney.edu.au)
  
&nbsp&nbsp{% if site.footer-links.twitter %}<a href="https://www.twitter.com/{{ site.footer-links.twitter }}"><i class="svg-icon twitter"></i></a>{% endif %}
  [https://twitter.com/TomAsh_1](https://twitter.com/TomAsh_1)
  
&nbsp&nbsp{% if site.footer-links.github %}<a href="https://github.com/{{ site.footer-links.github }}"><i class="svg-icon github"></i></a>{% endif %}
  [https://github.com/tomashhurst](https://github.com/tomashhurst)
  
&nbsp&nbsp{% if site.footer-links.linkedin %}<a href="https://www.linkedin.com/in/{{ site.footer-links.linkedin }}"><i class="svg-icon linkedin"></i></a>{% endif %}
  [https://www.linkedin.com/in/thomas-ashhurst/](https://www.linkedin.com/in/thomas-ashhurst/)

&nbsp&nbsp{% if site.footer-links.researchgate %}<a href="https://www.researchgate.net/profile/{{ site.footer-links.researchgate }}"><i class="svg-icon researchgate"></i></a>{% endif %}
