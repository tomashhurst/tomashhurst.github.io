...
Below is a collection of significant presentation and community activities.
...
I am actively involved in the [Human Cell Atlas (HCA)](https://www.humancellatlas.org/) community, including attendance at HCA general meetings in Hinxton, UK (2018), and [Tokyo, Japan (2019)](https://youtu.be/xYqd2w_aRH0?t=327), seeking to help define the contribution of high-dimensional cytometry and imaging technologies to the HCA objectives. I also presented on Spectre, one of our computational tools, at the [HCA Asia meeting](https://youtu.be/95dy_p5FFck?t=15491) (virtual) in 2020.

<p align="center"><iframe width="560" height="315" src="https://www.youtube.com/embed/95dy_p5FFck?start=15491" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
...
![ISAC](https://raw.githubusercontent.com/tomashhurst/tomashhurst.github.io/master/images/ISAC%20IMI.png)

I am a member of the [International Society for the Advancement of Immunology (ISAC)](https://isac-net.org/), and was awarded a prestigious ISAC [Marylou Ingram Scholarship](https://isac-net.org/page/Marylou-Ingram-Scholars) by ISAC in 2017. 
...
[Integration, exploration, and analysis of high-dimensional single-cell cytometry data using Spectre](https://www.youtube.com/embed/poEDERGXrQw?start=3151). Oz Single Cell webinar 2020, Computational biology.
...
![ASI](https://raw.githubusercontent.com/tomashhurst/tomashhurst.github.io/master/images/ASI.png)

I currently serves as the ‘Systems Cytometry’ & NSW representative of the [Systems Immunology special interest group (SIG)](https://www.immunology.org.au/asi-programs-and-opportunities/special-interest-groups/systems-immunology/) of the [Australian and New Zealand Society of Immunology](https://www.immunology.org.au/).
...
https://www.fluidigm.com/articles/imc-user-group-meeting-2019-recap
